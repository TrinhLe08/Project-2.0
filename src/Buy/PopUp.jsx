...
export default function PopUp({Pay}){
    ...
    return(
        <>
        {
            ...
            <div id="overlay">
                         <div className="pop">
                          <button className='button' onClick = {Vip.clickPop}>X</button>
                     ...
                     < HiOutlineCheckCircle className= 'stick'/>
                          ...
                          <p className="p">
                          Thanks you {Pay.name}  for support UI KIT PRO .
                          ...
                          <Link to="/Project-2.0" className="back"><button className="back">Back</button></Link>
