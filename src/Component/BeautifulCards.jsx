    ...
    <div className="Vip4">
      <div className="div">
        ...
        <p className="p1">
          {" "}
          {!Vip.vietSub
            ? "MỘT THẺ CHO MỌI VẤN ĐỀ"
            : "ONE CARD FOR EVERY PROBLEM"}
        </p>
        <p className="p2">
          {" "}
          {!Vip.vietSub
            ? "Từ thẻ được thiết kế cho các bài đăng trên blog, đến thẻ sản phẩm hoặc hồ sơ người dùng, bạn sẽ có nhiều tùy chọn để lựa chọn. Tất cả các thẻ đều tuân theo nguyên tắc phong cách Bộ công cụ giao diện người dùng hiện hành và có thiết kế nổi bật. Chúng tôi đã đi xa hơn với các tùy chọn để bạn sắp xếp thông tin của mình."
