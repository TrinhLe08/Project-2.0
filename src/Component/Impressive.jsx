  ...
  return (
    <div className="Vip2">
      <h1 className="h2">
        {" "}
        {!Vip.vietSub
          ? "Bộ sưu tập các thẻ ấn tượng"
          : "Impressive collection of elements "}
      </h1>
      <p className="p1">
        {" "}
        {!Vip.vietSub
          ? "Được thiết kế để trông tuyệt đẹp cùng nhau"
          : "Designed to look gorgeous together"}
      </p>
      <p className="p2">
        {" "}
        {!Vip.vietSub
          ? "Giờ đây, UI Kit Pro đi kèm với một số lượng lớn các yếu tố có thể tùy chỉnh. Chúng không chỉ được thiết kế pixel hoàn hảo và nhẹ nhàng mà còn dễ sử dụng và kết hợp tốt với các thành phần khác."
